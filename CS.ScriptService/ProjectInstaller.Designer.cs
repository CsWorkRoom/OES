...
namespace CS.ScriptService
{
    partial class ProjectInstaller
    {
        ...
        /// 服务名称
        /// </summary>
        private string _serviceName = "EasymanScriptServiceV4";
        private string _displayName = "EasymanScriptServiceV4";
        private string _description = "数据库脚本服务程序第四版";
        ...
        private static void UpdateServiceNameInBatFiles(string newServiceName)
        {
            ...
            string path = exeFile.Remove(exeFile.LastIndexOf('\\') + 1) + "\\Setup";
