...
{
    public class AJTM_SETUP_NATRUE:BBaseQuery
    {
        /// <summary>
        /// 单例
        /// </summary>
        public static AJTM_SETUP_NATRUE Instance = new AJTM_SETUP_NATRUE();
        #region 构造函数
        /// <summary>
        /// 构造函数
        /// </summary>
        public AJTM_SETUP_NATRUE()
        {
            this.IsAddIntoCache = true;
            this.TableName = "AJTM_SETUP_NATRUE";
            this.ItemName = "机构性质";
            this.KeyField = "ID";
